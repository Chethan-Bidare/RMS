...
public class TC003_VerifyItemName_Qty_Price_InApprovalPage extends TestBase{

	
	public static final Logger log = Logger.getLogger(TC003_VerifyItemName_Qty_Price_InApprovalPage.class.getName());
	...
	public void VerifyItemName_Qty_Price_InApprovalPage() throws InterruptedException{
		...
		Thread.sleep(5000);
		HashMap<String, ArrayList<String>> itemData  = approvalPage.getItemNameAndData();
