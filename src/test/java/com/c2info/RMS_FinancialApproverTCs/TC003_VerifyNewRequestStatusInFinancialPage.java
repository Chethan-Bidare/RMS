...
public class TC003_VerifyNewRequestStatusInFinancialPage extends TestBase {

	public static final Logger log = Logger.getLogger(TC003_VerifyNewRequestStatusInFinancialPage.class.getName());
	...
	@Test
	public void verifyStatusInFinancialPage() throws InterruptedException{
		...
		Thread.sleep(5000);
		homePage.doLogOut();
		homePage.doLogin(OR.getProperty("FinancialApprover"), "3321");
		homePage.ClickOnMenuOption("TRANSACTIONS");
		homePage.selectAnOptionFromSubMenu("FINANCIAL APPROVAL");
		Thread.sleep(5000);
		String actualResult = fap.getStatusBasedOnPRnumber(createdReq, "My Request");
