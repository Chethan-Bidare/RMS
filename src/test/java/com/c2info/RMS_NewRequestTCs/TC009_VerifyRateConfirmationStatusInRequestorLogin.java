...
public class TC009_VerifyRateConfirmationStatusInRequestorLogin extends TestBase{

	public static final Logger log = Logger.getLogger(TC009_VerifyRateConfirmationStatusInRequestorLogin.class.getName());
	...
	@Test
	public void verifyStatusInRequestorLoginPage() throws InterruptedException{
		...
		Thread.sleep(5000);
		homePage.doLogOut();
		homePage.doLogin(OR.getProperty("Requestor"), "3312");
		Thread.sleep(5000);
