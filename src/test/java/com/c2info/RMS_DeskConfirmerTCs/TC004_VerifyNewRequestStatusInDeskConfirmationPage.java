...
public class TC004_VerifyNewRequestStatusInDeskConfirmationPage extends TestBase{

	public static final Logger log = Logger.getLogger(TC004_VerifyNewRequestStatusInDeskConfirmationPage.class.getName());
	...
	@Test
	public void verifyStatusInDeskPage() throws InterruptedException{
